...
<section class="registration-result registration-result--error">
    <img class="result-star result-star--one" src="/assets/img/stars/7.svg" alt="" />
    <img class="result-star result-star--two" src="/assets/img/stars/9.svg" alt="" />

    <article class="result-card">
        <span class="result-eyebrow">{etiquetaEdicion}</span>
        <span class="result-icon" aria-hidden="true"><i class="fa-solid fa-xmark"></i></span>
        <h1>Error de inscripción</h1>
        <div class="result-copy">
            <p>No pudimos completar el envío.</p>
            <div class="result-details">
                <span>Intenta nuevamente y verifica que todos tus datos estén correctos.</span>
        ...
        <a class="result-action" href="/registro/">Volver al registro</a>
    </article>
</section>
...
<style>
    .registration-result {
        ...
        background:
            ...
            radial-gradient(circle at 85% 15%, rgba(255, 107, 107, 0.18), transparent 27%),
    ...
    .result-icon {
        ...
        font-size: 2rem;
        box-shadow: 0 0.8rem 2rem rgba(255, 107, 107, 0.28);
    }
